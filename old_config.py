...
class Wav2Vec2Config(PretrainedConfig):
    ...
    Args:
        ...
        cross_e_loss_weight (`int`, *optional*, defaults to 0.4):
            The weight of the codebook cross entropy loss component.
    ...
    def __init__(
        ...
        conv_dim=(64, 64, 64), #(64, 64, 64),(768, 768, 768)
        conv_stride=(3,2,2),
        ...
        mask_feature_prob=0.65,
        mask_feature_length=6,
        ...
        **kwargs
        ...
        self.cross_e_loss_weight = cross_e_loss_weight
        self.output_hidden_states = output_hidden_states
        # patch
        self.lfp_size = lfp_size
